          ...
          <div className="space-y-2 max-h-[600px] overflow-y-auto pr-2">
            {compatibleParts.length === 0 ? (
              ...
              compatibleParts.map(part => (
                <div key={part.id} className="flex items-center gap-3 p-3 bg-background border border-border/40 group hover:border-foreground/30 transition-colors">
        ...
        <div className="space-y-4">
          ...
          <form onSubmit={handleSearch} className="flex gap-2">
            <input 
              ...
              className="flex-1 bg-background border border-border/40 text-xs p-3 text-foreground focus:border-primary outline-none"
            />
