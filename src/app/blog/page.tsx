    ...
    <main className="min-h-screen bg-background text-foreground selection:bg-racing-yellow selection:text-carbon-dark">
        ...
        <div className="max-w-4xl mx-auto space-y-16">
          ...
          <div className="grid gap-8">
            {posts.length === 0 ? (
              <div className="text-center p-16 border border-border bg-carbon-dark/50">
              ...
              posts.map((post: any, idx: number) => (
                <div key={post.id} className={`fade-up-section visible group relative border border-border bg-background hover:border-racing-yellow/50 transition-colors p-8 md:p-10`} style={{ transitionDelay: `${idx * 100}ms` }}>
                  ...
                  <div className="flex flex-col md:flex-row gap-8 justify-between">
                    ...
                    <div className="md:w-48 shrink-0 flex flex-col justify-between items-start md:items-end border-t md:border-t-0 md:border-l border-border pt-6 md:pt-0 md:pl-6">
                      <div className="flex items-center gap-2 mb-6 md:mb-0">
                        <div className="h-8 w-8 bg-muted/50 border border-border flex items-center justify-center">
                      ...
                      <Link href={`/blog/${post.slug}`} className="flex items-center gap-2 text-xs font-mono font-bold tracking-widest uppercase text-primary hover:text-primary/90 transition-colors">
