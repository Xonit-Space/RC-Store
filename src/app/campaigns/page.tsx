    ...
    <div className="min-h-screen bg-background flex flex-col font-sans">
      ...
      <main className="flex-1 pt-32 pb-24 relative">
        ...
        <div className="px-6 md:px-12 lg:px-24 max-w-[1400px] mx-auto w-full mb-16 relative z-10 fade-up-section visible">
          ...
          <h1 className="font-heading text-4xl md:text-6xl font-black text-foreground dark:text-white uppercase drop-shadow-[0_0_15px_rgba(255,30,30,0.3)]">Pro Racing League</h1>
        </div>
            ...
            <section key={index} className="w-full fade-up-section visible" style={{ transitionDelay: `${index * 0.2}s` }}>
              <div className="px-6 md:px-12 lg:px-24 max-w-[1400px] mx-auto w-full grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-16 items-center">
                <div className={`md:col-span-7 ${index % 2 !== 0 ? 'md:order-2' : ''} group`}>
                  <div className="relative aspect-[4/3] w-full overflow-hidden bg-slate-100 dark:bg-smoke-dark border border-border group-hover:border-racing-red transition-all duration-500 shadow-[0_0_20px_rgba(0,0,0,0.5)] group-hover:shadow-[0_0_30px_rgba(255,30,30,0.3)]">
                    <Image
                      src={campaign.image}
                      alt={campaign.title}
                      fill
                ...
                <div className={`md:col-span-5 space-y-6 ${index % 2 !== 0 ? 'md:order-1' : ''} glass-dark p-8 border-l-2 border-transparent hover:border-racing-red transition-colors`}>
                  <p className="text-[10px] font-mono tracking-[0.2em] uppercase text-racing-red font-bold">
                    {campaign.season}
                  </p>
                  ...
                  <div className="pt-8">
                    <button className="text-[12px] font-heading tracking-[0.2em] uppercase font-bold border-b border-border text-foreground dark:text-white hover:text-racing-red hover:border-racing-red transition-colors pb-1">
                      Access Event Logs
                    </button>
                  </div>
                </div>
