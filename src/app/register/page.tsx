            ...
            {isSuccess ? (
              <div className="flex flex-col items-center justify-center py-8 text-center space-y-6">
                ...
                <div className="space-y-2">
                  <h3 className="font-heading font-bold text-xl text-foreground">Welcome to Aussie Rigs Arena</h3>
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="h-12 bg-muted border-border rounded-none text-foreground focus-visible:ring-0 focus-visible:border-racing-yellow focus-visible:shadow-[0_0_10px_rgba(255, 204, 0,0.3)] transition-all font-mono"
                  />
                  <p className="text-[9px] text-muted-foreground pt-1 font-mono uppercase tracking-wider">Must be at least 12 chars, include uppercase, lowercase, number, and special char.</p>
                </div>
