    ...
    <Popover>
      <PopoverTrigger asChild>
        <Button variant="ghost" size="icon" className="relative">
          ...
          {unreadCount > 0 && (
            <Badge className="absolute -top-2 -right-2 h-5 w-5 rounded-full p-0 text-xs flex items-center justify-center bg-yellow-500 hover:bg-yellow-600 animate-pulse text-white">
              {unreadCount}
            </Badge>
          )}
        </Button>
