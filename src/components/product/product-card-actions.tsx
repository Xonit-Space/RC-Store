    ...
    <>
      ...
      <div className="absolute inset-x-0 bottom-0 translate-y-full group-hover:translate-y-0 transition-transform duration-300">
        <button
          onClick={addToCart}
          disabled={isAdding}
          className="w-full py-3 bg-background/95 text-[10px] tracking-[0.25em] uppercase text-foreground hover:bg-racing-yellow hover:text-white transition-colors duration-200"
        >
