          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex flex-col justify-center">
              ...
              <h2 className="font-heading font-black text-4xl md:text-5xl text-foreground uppercase tracking-tight mb-4">
                Traxxas X-Maxx 8S <span className="text-primary">Brushless</span>
              </h2>
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-mono text-muted-foreground uppercase">50+ MPH Top Speed</span>
                </div>
                <div className="flex items-center gap-2">
                  <ShieldCheck className="w-5 h-5 text-primary" />
                  <span className="text-xs font-mono text-muted-foreground uppercase">Self-Righting Tech</span>
                </div>
                <div className="flex items-center gap-2">
                  <BatteryCharging className="w-5 h-5 text-primary" />
                  <span className="text-xs font-mono text-muted-foreground uppercase">8S LiPo Compatible</span>
                </div>
              </div>

              <div className="flex flex-col sm:flex-row gap-4">
                <CartIconButton className="relative z-20 flex-1 bg-primary text-primary-foreground font-heading font-black uppercase tracking-widest py-4 px-6 flex items-center justify-center gap-2 hover:bg-primary/90 transition-colors shadow-[0_0_15px_rgba(255, 204, 0,0.3)] hover:shadow-[0_0_25px_rgba(255, 204, 0,0.6)]">
                  <ShoppingCart className="w-5 h-5" />
                  Add to Cart
                </CartIconButton>
                <Link href="/products/traxxas-x-maxx" className="relative z-20 flex-1 border border-border text-foreground font-heading font-bold uppercase tracking-widest py-4 px-6 flex items-center justify-center hover:bg-white/5 hover:border-racing-yellow/50 transition-colors">
                  View Specs
                </Link>
              </div>
