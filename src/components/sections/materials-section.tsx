      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="mb-16 md:mb-24 max-w-lg fade-up-section visible">
          ...
          <h2 className="font-heading text-4xl md:text-5xl font-black leading-tight text-foreground dark:text-white uppercase tracking-tighter">
            Tech <span className="text-racing-red">Specs</span>
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-white/10 shadow-[0_0_30px_rgba(255,30,30,0.1)]">
          {performanceStats.map((stat, i) => (
            <div
              key={stat.name}
              className={`${stat.texture} p-10 md:p-14 group hover:bg-racing-red/10 transition-colors duration-500 relative overflow-hidden fade-up-section visible`}
              ...
              <div className="space-y-4 relative z-10">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <h3 className="font-heading text-2xl md:text-3xl font-black text-foreground dark:text-white uppercase tracking-tight group-hover:text-racing-red transition-colors">
                      {stat.name}
                    </h3>
                  </div>
        ...
        <div className="mt-16 text-center fade-up-section visible">
          <Link
            href="/materials"
            className="inline-flex items-center gap-3 text-[12px] font-heading font-bold tracking-[0.25em] uppercase text-muted-foreground hover:text-racing-red hover:shadow-[0_0_15px_rgba(255,30,30,0.5)] transition-all bg-slate-100 dark:bg-smoke-dark px-6 py-3 border border-border hover:border-racing-red"
          >
            Specs Overview →
          </Link>
        </div>
