      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="mb-16 md:mb-24 max-w-lg fade-up-section visible">
          ...
          <h2 className="font-heading text-4xl md:text-5xl font-black leading-tight text-foreground dark:text-white uppercase tracking-tighter">
            Tech <span className="text-primary">Specs</span>
          </h2>
        </div>

        {/* Performance Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-muted shadow-[0_0_30px_rgba(255, 204, 0,0.1)]">
        ...
        <div className="mt-16 text-center fade-up-section visible">
          <Link
            href="/materials"
            className="inline-flex items-center gap-3 text-[12px] font-heading font-bold tracking-[0.25em] uppercase text-muted-foreground hover:text-primary hover:shadow-[0_0_15px_rgba(255, 204, 0,0.5)] transition-all bg-slate-100 dark:bg-smoke-dark px-6 py-3 border border-border hover:border-primary"
          >
            Specs Overview →
          </Link>
        </div>
