...
export function PartFinderBanner() {
  ...
  return (
    <section className="relative bg-carbon-dark py-24 border-t border-white/5 overflow-hidden">
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        <div className="max-w-2xl">
          <div className="flex items-center gap-2 mb-4">
            ...
            <p className="text-[10px] font-bold tracking-[0.3em] uppercase text-racing-yellow">Precision Upgrades</p>
          </div>
          
          <h2 className="font-heading font-black text-4xl md:text-5xl text-white uppercase tracking-wider mb-6">
          ...
          <div className="glass-dark border border-white/10 p-6 md:p-8 flex flex-col md:flex-row gap-4 mb-8">
            <select 
              value={makeId} 
              onChange={(e) => {
              ...
              className="flex-1 bg-smoke-dark border border-white/10 text-white p-4 font-mono text-sm outline-none focus:border-racing-yellow transition-colors"
            >
            ...
            <select 
              ...
              disabled={!makeId}
              className="flex-1 bg-smoke-dark border border-white/10 text-white p-4 font-mono text-sm outline-none focus:border-racing-yellow disabled:opacity-50 transition-colors"
            >
            ...
            <button 
              disabled={!modelId}
              className="bg-racing-yellow text-carbon-dark font-heading font-black uppercase tracking-widest px-8 py-4 flex items-center justify-center gap-2 hover:bg-neon-yellow transition-colors shadow-[0_0_15px_rgba(255, 204, 0,0.3)] disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          <div className="flex flex-col sm:flex-row gap-6 border-t border-white/10 pt-8">
            <div className="flex items-center gap-3 text-muted-foreground hover:text-white transition-colors cursor-pointer">
              <Map className="w-5 h-5 text-racing-yellow" />
              <span className="font-mono text-xs uppercase tracking-widest">Exploded Diagrams</span>
            </div>
            <div className="flex items-center gap-3 text-muted-foreground hover:text-white transition-colors cursor-pointer">
              <FileText className="w-5 h-5 text-racing-yellow" />
