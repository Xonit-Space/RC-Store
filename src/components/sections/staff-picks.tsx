        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 bg-carbon-dark border border-white/10 p-8 md:p-12 relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col sm:flex-row items-center gap-8">
            ...
            <div className="w-full sm:w-1/2 flex flex-col">
              ...
              <button className="bg-white/10 hover:bg-racing-yellow text-white hover:text-carbon-dark border border-white/20 hover:border-racing-yellow font-heading font-bold uppercase tracking-widest py-3 px-4 flex items-center justify-center gap-2 transition-colors text-sm">
