  ...
  switch (eventType as EventType) {
    case "ORDER_CREATED":
      return {
        ...
        message: `Thank you! Your order #${payload.orderId} of total $${payload.total.toFixed(2)} has been registered.`,
    ...
    case "PAYMENT_COMPLETED":
      return {
        ...
        message: `Payment of $${payload.amount.toFixed(2)} for order #${payload.orderId} was processed successfully.`,
    ...
    case "USER_REGISTERED":
      return {
        ...
        type: "SYSTEM",
        title: "Welcome to Neoshop Ultra!",
    ...
    case "REFUND_ISSUED":
      return {
        ...
        message: `A refund of $${payload.amount.toFixed(2)} has been processed for order #${payload.orderId}.`,
