...
export async function uploadImage(fileUri: string, folderName = "neoshop-ultra") {
  if (!cloudName || !apiKey || !apiSecret) {
    console.warn("Cloudinary is not configured. Falling back to local placeholder image.")
